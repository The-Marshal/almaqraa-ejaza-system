    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-xs-12 col-md-3 mb-3">
                <input id="fname" type="text" class="form-control" name="fname" disabled value="{{$usersName->name}}" placeholder="الاسم الاول" autocomplete="fname" autofocus="" />
            </div>
            <div class="col-xs-12 col-md-3 mb-3">
                <input id="sname" type="text" class="form-control" name="sname" disabled value="{{$usersName->mdlname}}" placeholder="الاسم الثاني" autocomplete="sname" />
            </div>
            <div class="col-xs-12 col-md-3 mb-3">
                <input id="tname" type="text" class="form-control" name="tname" disabled value="{{$usersName->thrdname}}" placeholder="الاسم الثالث" autocomplete="tname" />
            </div>
            <div class="col-xs-12 col-md-3 mb-3">
                <input id="lname" type="text" class="form-control" name="lname" disabled value="{{$usersName->lastname}}" placeholder="اللقب" autocomplete="lname" />
            </div>
...
<div class="row mb-3">
    ...
    <div class="col-md-5">
        ...
        <div class="col-md-10">
            <input id="nat" type="text" class="form-control "  value="{{$usersName->nationality}}" name="nat" disabled autocomplete="nat">
...
<div class="row mb-3">
    <div class="col-md-7">
        ...
        <div class="col-md-9">
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" disabled value="{{$usersName->email }}" autocomplete="email">
...
<div class="row mb-3">
    ...
    <label for="gender" class="col-md-2 col-form-label text-md-start text-muted">{{ __('الجنس') }}</label>
        ...
        <div class="col-md-10">
            <div class="form-check form-check-inline" id="gender">
                <input class="form-check-input" type="radio" name="gender" disabled id="male" value="male" @if($usersName->gender == 'male') checked @endif >
                <label class="form-check-label text-muted" for="male" attr="{{$usersName->gender}}">ذكر</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" id="female" disabled value="female" @if($usersName->gender == 'female') checked @endif >
                <label class="form-check-label text-muted" for="female" attr="{{$usersName->gender}}">انثى</label>
              </div>
    ...
    <div class="col-md-8">
        ...
        <div class="col-md-8">
            ...
            <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{$usersName->mobile }}" disabled autocomplete="mobile">
                </div>
